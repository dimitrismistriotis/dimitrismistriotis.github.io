...
I wanted to check out this book so I downloaded it. Most of the time I end up
buying the actual book at the end so do not feel that guilty. With "Python
Tricks" I was 100% sure I would eventually purchase it, which I did.
...
Python (IM-not-so-HO). Last but not least if acquired from the book's site
(see link) there are 12 (!) videos about the main concepts discussed with live
coding sessions with the author explaining the rationale behind each decision.
