...
> Σκεφθείτε την ταινά "Social Network": ξεκινάει με 10 λεπτά όπου δύο παιδία γράφουν κώδικα σε ένα γκαραζ και συνεχίζει όταν έχουν γίνει εκατομυριούχοι. Κανείς ποτέ δεν αναρωτήθηκε στο τι συνέβη ενδιάμεσα;
...
## Δεν παίζει ρόλο το σε ποια χώρα/πόλη δραστηριοποιήται μια εταιρία.
